...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public ScreenManager(Game game)
            : base(game)
        {
           //TODO: call gamepad or keyboard initialization if require
        }
        ...
        {
            //TODO: Load content belonging to the screen manager.
            ContentManager content = Game.Content;

            spriteBatch = new SpriteBatch(GraphicsDevice);
            font = content.Load<SpriteFont>("MainFont");
            blankTexture = content.Load<Texture2D>("characterselect");
        ...
        public void RemoveScreen(GameScreen screen)
        {
            ...
            if (screens.Count > 0)
            {
                 //TODO: update the input = screens[screens.Count - 1].EnabledInput;
