...
namespace GameStateManagement
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        {
           //TODO: update input state if needed
        ...
        {
            // we cancel the current menu screen if the user presses the B button
            PlayerIndex player;
            if (input.IsNewButtonPress(Buttons.B, ControllingPlayer, out player))
            {
                OnCancel(player);
            }
            ...
            foreach (KeyboardState kstate in input.CurrentKeyboardStates)
            {
        ...
        /// <summary>
        ///TODO: Allows the screen the chance to position the menu entries. By default
